...
const requiredPhrases = [
  ...
  'Work',
  'Generations Kitchen',
  'The food gets the first word. By the time the menu appears, you’re already deciding what to order.',
  'Pā‘ina Café',
  'Pā‘ina means gathering. The story starts in the kitchen, then follows the food until it lands in someone’s hands.',
  'Explore the restaurant concept',
  'Rana Levy',
  'The ring catches your eye. Then the stone shifts in the light, and you have to look again.',
  'Ready Now',
  'Made To Order',
  'Custom Consultation',
  'Explore the concept',
  'Dylan Prorok',
  'A large tattoo has to feel like it belongs on the body. Up close you see the detail, but across the room the whole piece still reads.',
